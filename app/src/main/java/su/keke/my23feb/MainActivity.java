...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = (EditText)findViewById(R.id.etimen);
        mTextView = (TextView)findViewById(R.id.tvimen);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mEditText.getText().length() == 0) {
                    mTextView.setText("Введите имя!");
                } else {
                    String[]gum_list = getResources().getStringArray(R.array.pozdr);
...
//Теперь строим фразу
                    ...
                    //mTextView.setText(phrase);//вставляем фразу
                    mTextView.setText(mEditText.getText() + ", Поздравляю с 23 февраля! " + phrase);
                }
            }
        });
